...
function displayUserIdentity() {
    ...
    if (navContainer) {
        ...
        badge.innerHTML = `Halo, <strong style="max-width: 140px; display: inline-block; vertical-align: bottom; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="${nama}">${nama}</strong> (${roleInfo})`;
        badge.style.cssText = `
